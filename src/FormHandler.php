...
class FormHandler
{
	...
	public function __construct()
	{
		...
		$this->mailer->Subject = "There has been a new application for a quote from the Jestalt website.";

		$host = isset($_SERVER['SERVER_NAME'])?$_SERVER['SERVER_NAME']:'localhost';
        $from_email ='info@jestalt.com';
   		$this->mailer->setFrom($from_email,'Jestalt Website',false);  
	...
	{
		$content = "Here follows the details of the application for a quote: \n\n";
